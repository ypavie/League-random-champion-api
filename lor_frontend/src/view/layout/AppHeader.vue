<template>
  <header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full text-sm">
   <nav class="relative max-h-[5rem] w-full mx-auto bg-white border-b border-gray-200 py-3 px-4 sm:py-0 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:border-x dark:bg-gray-800 dark:border-gray-700" aria-label="Global">
         <div class="flex items-center justify-between">
            <!-- add logo.png from assets folder -->
            <img src="@/assets/logo.png" alt="logo" class="h-16" />
            <a class="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand">League Of Random</a>
         </div>
